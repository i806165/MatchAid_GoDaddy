...
if (!is_file($composerAutoload)) {
    throw new RuntimeException(
        'Composer autoloader is missing: ' . $composerAutoload
    );
}

require_once $composerAutoload;

// NOTE: TCPDF font-path setup (MA_PDF_FONTS / K_PATH_FONTS) intentionally
// lives in exportScoreCardsPdf.php, not here. bootstrap.php loads on every
// page in the app; a missing/unreadable font folder should only break the
// one PDF export feature that needs it, not the entire site.
...
define('MA_ROUTE_API_ADMIN_GAMES', '/api/admin_home');
define('MA_ROUTE_ADMIN_GAMES',     '/app/admin_home/adminhome.php');
...
define('MA_ROUTE_API_SCORE_SIDEGAMES', '/api/score_sidegames');
...
define('MA_ROUTE_SCORE_SIDEGAMES', '/app/score_sidegames/scoresidegames.php');
define('MA_ROUTE_API_SCORE_SUMMARY', '/api/score_summary');
define('MA_ROUTE_SCORE_SUMMARY', '/app/score_summary/scoresummary.php');
define('MA_ROUTE_API_SCORE_GIS', '/api/score_gis');
define('MA_ROUTE_SCORE_GIS', '/app/score_gis/scoregis.php');
