...
// TCPDF font assets generated by tc-lib-pdf-font
define(
    'MA_PDF_FONTS',
    MA_VENDOR . '/tecnickcom/tc-lib-pdf-font/target/fonts/'
);

if (!is_dir(MA_PDF_FONTS)) {
    throw new RuntimeException(
        'TCPDF font directory is missing: ' . MA_PDF_FONTS
    );
}

if (!is_readable(MA_PDF_FONTS)) {
    throw new RuntimeException(
        'TCPDF font directory is not readable: ' . MA_PDF_FONTS
    );
}
