...
<footer class="maChrome__ftr" role="contentinfo">
  ...
  <nav id="chromeBottomNav" class="maChrome__bottomNav" aria-label="Primary">
    ...
    <button type="button" class="maNavBtn" data-nav="clubhome" aria-label="Club Home">
      <span class="maNavIcon" aria-hidden="true">
        <img src="/assets/images/nav-club-home.png" alt="" width="26" height="26" style="display:block; object-fit:contain;">
      </span>
      <span class="maNavLabel">Club Home</span>
    </button>

    <button type="button" class="maNavBtn" data-nav="clubdemand" aria-label="Club Demand">
      <span class="maNavIcon" aria-hidden="true">
        <img src="/assets/images/nav-club-demand.png" alt="" width="26" height="26" style="display:block; object-fit:contain;">
      </span>
...
<!-- /////// EVENT SECTION ////// -->
    <button type="button" class="maNavBtn" data-nav="eventhome" aria-label="Events Home">
      <span class="maNavIcon" aria-hidden="true">
        <img src="/assets/images/nav-event.png" alt="" width="26" height="26" style="display:block; object-fit:contain;">
      </span>
      <span class="maNavLabel">Events Home</span>
    </button>
    ...
    <button type="button" class="maNavBtn" data-nav="eventskins" aria-label="Event Skins">
      <span class="maNavIcon" aria-hidden="true">
        <img src="/assets/images/nav-skins.png" alt="" width="26" height="26" style="display:block; object-fit:contain;">
      </span>
      <span class="maNavLabel">Event Skins</span>
    </button>
