    ...
    <div class="maCards">
        <section class="maCard maLoginCard" aria-label="MatchAid login form">
            ...
            <div class="maCard__body">
                ...
                <div id="loginErrorMsg" class="maPill maPill--danger" role="alert" style="display:none; margin-top:12px;"></div>

                <div class="maInputWrap" style="justify-content:flex-end; margin-top:12px;">
