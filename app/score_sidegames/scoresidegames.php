...
// /public_html/app/score_sidegames/scoresidegames.php

require_once __DIR__ . "/../../bootstrap.php";
require_once MA_API_LIB . "/Logger.php";
require_once MA_SERVICES . "/context/service_ContextUser.php";
require_once MA_SERVICES . "/context/service_ContextGame.php";
require_once MA_API . "/score_sidegames/initScoreSidegames.php";
...
try {
  ...
  // initScoreSidegames.php calls for its own POST entrypoint.
  ...
  Logger::error("SCORESIDEGAMES_INIT_FAIL", ["err" => $e->getMessage()]);
...
$paths = [
    ...
    "initScoreSidegames" => MA_ROUTE_API_SCORE_SIDEGAMES . "/initScoreSidegames.php",
];

$maChromeTitle    = "Side Games";
$maChromeSubtitle = trim((string)($initPayload["game"]["dbGames_CourseName"] ?? ""));
?>
<!DOCTYPE html><html lang="en"><head>
<meta charset="UTF-8" />
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1" />
<title>MatchAid — Side Games</title>
...
<?php require __DIR__ . '/scoresidegames_view.php'; ?>
...
<script src="<?= ma_asset('/assets/pages/score_sidegames.js') ?>"></script>
</body></html>
